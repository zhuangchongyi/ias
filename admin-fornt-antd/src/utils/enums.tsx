...
export const buildEnum = <T extends Record<number, { id: string; defaultMessage: string }>>(
  map: T,
) => {
  const valueEnum: Record<number, { text: JSX.Element; status: string }> = {};
...
export const StatusEnum = buildEnum({
  0: { id: 'enums.status.disable', defaultMessage: '禁用' },
  1: { id: 'enums.status.enable', defaultMessage: '启用' },
});
